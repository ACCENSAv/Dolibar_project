...
$config['plugins'] = ['archive', 'password', 'userinfo','save2dolibarr', 'autologon'];
...
// 💡 Change le chemin vers le dossier de logs pour macOS (et non Windows)
$config['log_dir'] = 'C:/wamp64/www/dolibarr/htdocs/custom/roundcubemodule/roundcube/logs/';
